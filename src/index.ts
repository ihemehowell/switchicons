...
// West African fintech / payment-rail icons
export { Naira } from "./icons/Naira";
export { BankTransfer } from "./icons/BankTransfer";
export { Ussd } from "./icons/Ussd";
export { Pos } from "./icons/Pos";
